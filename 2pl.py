...
while korablicol != [] and korablicol != [] or korablicol != [] and korablicol != [] :
    while True:
        ...
        #ход 1го игрока
        print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
        input("First player turn, press enter when the second player leaves")
        print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
        board_display(board1)
        print("-------------------")
        board_display(board2)
        while True:
            try:
                ...
                print("ээээ, ты не так ввел, попробуй еще раз")
        break  
...
# игрок 2
    ...
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
    input("Second player turn, press enter when the first player leaves")
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
    board_display(board)
    print("-------------------")
    board_display(board3)
    while True:
        try:
    ...
    if shipchekb(guess_row2, guess_col2) == True:
        board3[guess_row2][guess_col2] = "■"
        board1[guess_row2][guess_col2] = "▓"
        print("ты попал!")
        del korablirowig[indexb]
        del korablicolig[indexb]
    else:
        while True:
            try:
                board3[guess_row2][guess_col2] = "X"
